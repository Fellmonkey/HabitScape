...
abstract final class TourContent {
  ...
  static const greenhouseHabit = TourStep(
    'Отметки привычек',
    'Свайп по карточке — пропустить или удалить. Долгий тап — выполнить.',
  );

  // ── Month spread (Разворот месяца) ───────────────────────
  static const spreadSwipe = TourStep(
    'Листай месяцы',
    'Свайп влево-вправо или стрелки вверху — прошлые месяцы тоже открыты.',
  );
  ...
  static const settingsHere = TourStep(
    'Здесь настройки',
    'Вкладка называется «Ещё», но это раздел настроек: бэкап, архив, хептики.',
  );
}
